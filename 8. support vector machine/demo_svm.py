...
class MaskDetection:
    ...
    def __init__(self,mode='rasp'):
        ...
        self.cls = load('./models/svc.joblib')  # svm 模型

        # 标签
        self.labels = ['正常','未佩戴','不规范']
        # 颜色，BGR顺序，绿色、红色、黄色
        self.colors = [(0,255,0),(0,255,255),(0,0,255)]
    ...
    def detect(self):
        ...
        while True:
            ...
            for index in range(num_of_detections):
                ...
                if detection_confidence>0.5:
                    ...
                    #    img_input = blob_norm.reshape(1,100,100,3)
                        ...
                        # 标签
                        if predictLabels == 'mask_cor':
                            Lab_index = 0
                        elif predictLabels == 'mask_uncor':
                            Lab_index = 1
                        else:
                            Lab_index = 2
                        ...
                        # 中文标签
                        overlay = self.zh_label_img_list[Lab_index]
                        ...
                        #    cv2.putText(frame, str( (overlay_r+20, overlay_t+40), cv2.FONT_ITALIC, 0.8, self.colors[Lab_index], 2)

                    # 人脸框
                    cv2.rectangle(frame,(l,t),(r,b),self.colors[Lab_index],5)
            ...
            cv2.putText(frame, "FPS:  " + str(round(fpsText,2)), (20, 60), cv2.FONT_ITALIC, 1, (0, 255, 0), 3)
            cv2.putText(frame, "Person:  " + str(person_count), (20, 110), cv2.FONT_ITALIC, 1, (0, 255, 0), 3)
